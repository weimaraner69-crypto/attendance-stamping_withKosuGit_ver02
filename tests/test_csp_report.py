...
def test_get_csp_spike_alert_priority_threshold_overrides_from_env_閾値未指定は例外() -> None:
    """directive別上書き閾値で値未指定なら例外を返す。"""
    env = {
        "CSP_SPIKE_ALERT_PRIORITY_INCREASE_RATIO_THRESHOLD_OVERRIDES": "script-src-elem="
    }
